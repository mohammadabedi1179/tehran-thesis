...
sub makeglo2gls {
    system("xindy -L persian-variant2 -C utf8 -I xindy -M \"$_[0].xdy\" -t \"$_[0].glg\" -o \"$_[0].gls\" \"$_[0].glo\"");
}

add_cus_dep('blo', 'bls', 0, 'makeblo2bls');
sub makeblo2bls {
    system("xindy -L persian-variant2 -C utf8 -I xindy -M \"$_[0].xdy\" -t \"$_[0].blg\" -o \"$_[0].bls\" \"$_[0].blo\"");
}
