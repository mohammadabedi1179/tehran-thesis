...
% شماره‌گذاری پاورقی‌ها در هر صفحه از ۱ آغاز می‌شود.
% حذف وابستگی پاورقی به فصل در ابتدای سند انجام می‌شود تا هیچ بسته یا کلاسی
% نتواند بعداً وابستگی فصل را دوباره برقرار کند.
\AtBeginDocument{%
    \counterwithout{footnote}{chapter}%
}
% پس از خروج هر صفحه، شمارنده صفر می‌شود؛ بنابراین نخستین پاورقی صفحهٔ بعد ۱ است.
% این روش به فایل کمکی یا چند بار کامپایل برای تعیین شمارهٔ پاورقی وابسته نیست.
\AddToHook{shipout/after}{\setcounter{footnote}{0}}
...
%% هیچ بازنشانی یا قالب ویژه‌ای اعمال نمی‌شود؛ شمارهٔ صفحات پیوست ادامهٔ
%% مستقیم شمارهٔ صفحات متن اصلی است.
